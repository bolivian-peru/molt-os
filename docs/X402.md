...
> **Inbound x402 is live.** spawn.os.moda accepts USDC payments via x402 for server provisioning (see [SPAWN-API.md](SPAWN-API.md)). This document describes the **outbound** side — the OS autonomously paying for external APIs through osmoda-egress + osmoda-keyd.
